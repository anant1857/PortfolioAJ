...
// const GITHUB_USERNAME = "AmolSonawane1026"; // Change to your GitHub username
...
//         {/* Center: File Path */}
//         {/* <div className="hidden md:flex items-center space-x-2 text-[#888888] text-xs">
//           <span className="text-[#007acc]">~/</span>
//           <span>github:</span>
//           <span className="text-[#cccccc]">{GITHUB_USERNAME}.profile</span>
//         </div> */}
...
//         <div className="px-4 py-2 bg-[#1e1e1e] border-r border-[#333333] border-t-2 border-t-[#007acc] text-[#cccccc] text-sm font-medium">
...
//                 <div className="text-[#ffffff] font-bold text-lg">{profile.public_repos}</div>
//                 <div className="text-[#888888]">Repositories</div>
//               </div>
//               <div className="bg-[#1e1e1e] rounded-lg p-3 border border-[#333333]">
//                 <div className="text-[#ffffff] font-bold text-lg">{profile.followers}</div>
//                 <div className="text-[#888888]">Followers</div>
//               </div>
//               <div className="bg-[#1e1e1e] rounded-lg p-3 border border-[#333333]">
//                 <div className="text-[#ffffff] font-bold text-lg">{profile.following}</div>
//                 <div className="text-[#888888]">Following</div>
//               </div>
//               <div className="bg-[#1e1e1e] rounded-lg p-3 border border-[#333333]">
//                 <div className="text-[#ffffff] font-bold text-lg">{profile.public_gists}</div>
...
//                      className="text-[#007acc] hover:underline truncate">
//                     {profile.blog}
//                   </a>
//                 </div>
//               )}
...
//               className="w-full bg-[#007acc] hover:bg-[#005a9e] text-white px-4 py-2 rounded-lg text-center text-sm font-medium transition-colors duration-200"
//             >
//               View on GitHub
//             </a>
//           </div>
...
//                     <h3 className="text-[#007acc] font-semibold text-lg group-hover:text-[#4da6ff] transition-colors">
//                       📂 {repo.name}
//                     </h3>
